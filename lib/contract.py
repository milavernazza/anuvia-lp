...
<p style="color:#475569;line-height:1.65;margin:0 0 14px;">Segue o contrato de <strong>{deliverable}</strong> que conversamos.</p>
...
<p style="color:#78716c;font-size:13px;line-height:1.6;margin-top:28px;">Qualquer dúvida, é só responder este email.<br><br>Anuvia</p>
</div></body></html>"""
